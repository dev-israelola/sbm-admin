...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-3 text-left text-sm font-medium text-ink transition-colors hover:text-accent",
    ...
    >
      {children}
      <ChevronDown className="h-3.5 w-3.5 text-ink-muted transition-transform" />
    </AccordionPrimitive.Trigger>
